...
interface DataTableDrillCategoryProps<TData extends HasId> {
  data: TData[];
...
function DataTableDrillCategory<TData extends HasId>({
  data,
  columns,
  modalContent,
  onSaveData,
}: DataTableDrillCategoryProps<TData>) {
    ...
    <>
      ...
      <Dialog open={isModalOpen} onOpenChange={handleCloseModal}>
        <DialogContent className="md:max-w-[800px]">
          <DialogTitle>Drill Category</DialogTitle>
...
export default DataTableDrillCategory;
