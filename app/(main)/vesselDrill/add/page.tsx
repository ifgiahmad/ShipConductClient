...
import { saveTrVesselDrill } from "@/services/service_api_vesselDrill";
...
import { getMsDrillCategoryByVslType } from "@/services/service_api_drillCategory";

const AddVesselDrillForm: React.FC = () => {
  const [vesselName, setVesselName] = useState<MsVessel[]>([]);
  const [DrillCategory, setDrillCategory] = useState<MsDrillCategory[]>([]);
...
export default AddVesselDrillForm;
